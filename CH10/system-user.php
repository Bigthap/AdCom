...
?>
    ...
    <form method="post" action="system-user.php">
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="text-align:center; padding-top:10px;">
                    ...
                    <a href="system-user.php">Cancel</a>
                </td>
            </tr>
        </table>
    </form>
...
<?php
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='system-user.php?edit=" . $row['user_id'] . "'>Edit</a></td>";
        echo "<td><a href='system-user.php?delete=" . $row['user_id'] . "' onclick=\"return confirm('Are you sure you want to delete this user?');\">Delete</a></td>";
        echo "</tr>";
    }
?>
    </table>
