...
<?php
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" . $row["name"] . "</td>";
        echo "<td><a href='department.php?edit=" . $row['department_id'] . "'>Edit</a></td>";
        echo "<td><a href='department.php?delete=" . $row['department_id'] . "' onclick=\"return confirm('Are you sure you want to delete this department?');\">Delete</a></td>";
        echo "</tr>";
    }
?>
    </table>
