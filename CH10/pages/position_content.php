...
?>
    <h3>Edit Position</h3>
    <form method="post" action="index.php?page=position">
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="text-align:center; padding-top:10px;">
                    ...
                    <a href="index.php?page=position">Cancel</a>
                </td>
            </tr>
        </table>
    </form>
...
<?php
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" . $row["name"] . "</td>";
        echo "<td><a href='index.php?page=position&edit=" . $row['position_id'] . "'>Edit</a></td>";
        echo "<td><a href='index.php?page=position&delete=" . $row['position_id'] . "' onclick=\"return confirm('Are you sure you want to delete this position?');\">Delete</a></td>";
        echo "</tr>";
    }
?>
    </table>
