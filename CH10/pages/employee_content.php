...
?>
    <h3>Edit Employee</h3>
    <form method="post" action="index.php?page=employee">
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="text-align:center; padding-top:10px;">
                    ...
                    <a href="index.php?page=employee">Cancel</a>
                </td>
            </tr>
        </table>
    </form>
...
<?php
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if ($level == 3) {
            echo "<td><a href='index.php?page=employee&edit=" . $row['employee_id'] . "'>Edit</a></td>";
            echo "<td><a href='index.php?page=employee&delete=" . $row['employee_id'] . "' onclick=\"return confirm('Are you sure you want to delete this employee?');\">Delete</a></td>";
        }
        echo "</tr>";
    }
?>
